  ...
  <div class="kk_tab ">
    <div class="row text-center" style="padding: 15px;">
      <div class="col-xm-6" style="background: #eaeaea;font-weight:700;width:25%">
        <a class="nav-link active_medium" href="javascript:void(0)" data-type="teacher" id="TEACHER">Teacher</a>
      </div>
      <div class="col-xm-6" style="background: #eaeaea;font-weight:700;width:25%">
        <a class="nav-link" href="javascript:void(0)"  data-type="moderator" id="MODERATOR">Moderator</a>
      </div>
      <div class="col-xm-6" style="background: #eaeaea;font-weight:700;width:25%">
        <a class="nav-link" href="javascript:void(0)"  data-type="student" id="STUDENT">Student</a>
      </div>
      <div class="col-xm-6" style="background: #eaeaea;font-weight:700;width:25%">
        <a class="nav-link" href="javascript:void(0)"  data-type="admin" id="ADMIN">Admin</a>
      </div>
    </div>
